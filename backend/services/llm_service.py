...
- 욕설·비방 등급 기준:
  · LOW: 특정 대상 없는 감탄사·경미한 불쾌 표현
  · MEDIUM: 특정 대상 없는 일반적 욕설·막말
  · HIGH: 특정인을 직접 겨냥한 욕설·외모/신체/성격 비하·명예훼손성 표현
  · CRITICAL: 조직적·반복적 허위사실 유포로 명백한 피해 유발, 또는 공개적 신상 공개와 결합한 집단 공격

- 협박·위협 등급 기준:
  · LOW: 비유적·감정적 표현 ("죽이고 싶다" 수준의 과장 표현), 제3자 인용
  · MEDIUM: 모호하거나 조건부 위협, 맥락상 실행 가능성이 낮은 표현
  · HIGH: 특정인을 대상으로 한 직접적 위협·협박 표현
  · CRITICAL: 구체적 수단·장소·시간이 포함된 즉각적 신체 위협, 또는 다수를 향한 폭력 예고

- 범죄 관련 등급 기준:
  · LOW: 범죄를 다룬 뉴스 인용·피해자 신고·교육 목적 설명
  · MEDIUM: 범죄 행위를 간접적으로 암시하거나 모호하게 묘사
  · HIGH: 범죄 행위 직접 묘사·조장·방법 공유·권유
  · CRITICAL: 구체적 범행 계획 공유, 즉각 실행 가능한 범죄 수단·정보 제공

- 스팸·홍보성 요소 등급 기준:
  · LOW 불가: 스팸 요소가 조금이라도 있으면 최소 MEDIUM(0.30 이상)
  · MEDIUM: 링크·이미지 없이 채널·공유방 개설 안내, 간접적 추천 문구
  · HIGH: 직접적 광고 문구·반복 도배·구매/참여/투자 권유·수익 보장 주장
  · CRITICAL: 외부 링크·이미지 첨부와 함께 사기성 사이트 연결 또는 허위 정보로 금전적 피해 유발 가능성이 확인된 경우

- 성적 표현 등급 기준:
  · LOW: 가벼운 성적 뉘앙스, 일반적인 연애·신체 표현
  · MEDIUM: 다소 노골적이나 성인 간 합의된 맥락의 성적 표현, 선정적 묘사
  · HIGH: 비동의·강압적 성행위 묘사, 성적 모욕·희롱, 포르노그래피 수준의 노골적 표현
  · CRITICAL: 미성년자 대상 성적 표현·묘사, 성적 착취·그루밍 권유 (맥락 무관 무조건 CRITICAL)

- 자해·자살 표현 등급 기준:
  · LOW: 도움 요청·피해자 신고·뉴스 인용·교육·예방 목적의 언급
  · MEDIUM: 자해·자살에 대한 감정적 호소나 막연한 언급, 본인의 심리적 고통 표현
  · HIGH: 구체적 자해·자살 방법 서술, 특정인에게 자해를 권유하거나 조장하는 표현
  · CRITICAL: 즉각적 실행 가능성이 높은 구체적 수단·계획 공유, 다수를 향한 자해·자살 권유

- 개인정보 침해 등급 기준:
  · LOW: 공개된 인물의 이름·직함 등 일반적으로 알려진 정보 언급
  · MEDIUM: 반공개적 정보(직장·학교·거주 지역 등) 언급, 단독으로는 식별 어려운 수준
  · HIGH: 이름+주소, 전화번호+계좌 등 조합으로 특정인 식별·피해 가능한 정보 노출
  · CRITICAL: 악의적 신상 공개(doxing), 주민번호·금융정보·비공개 사진 등 민감 정보 유포·유포 권유
